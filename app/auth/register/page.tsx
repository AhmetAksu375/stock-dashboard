...
import { handleRegisterRequest } from '../../../api/Auth/register';
...
export default function page() {
    ...
    const handleRegister = ()=>{
        handleRegisterRequest({username:username, password: password , mail:mail})
    }

  return (
  <div className='flex justify-center'>
      <div className='flex flex-col justify-center w-[400px] py-32 gap-4'>
        <h3 className="text-left pl-2 font-bold text-4xl  pb-4">Register</h3>
  ...
  <input type="text" className="grow" placeholder="Email" value={mail} onChange={(e)=>setMail(e.target.value)} />
</label>
